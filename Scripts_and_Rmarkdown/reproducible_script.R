...
slices = unique(org$project_name)


#Make sure the object is called org2 or whatever you chang it to 
for(v in slices){
  render("rmarkdown/project_summaries.Rmd",
         output_file=paste0("C:/Users/tenis/Desktop/Data_Projects/connect_matching/reports/project_summaries/rgk_project_summaries/Summer 2022/", v, ".pdf")
         )
}
