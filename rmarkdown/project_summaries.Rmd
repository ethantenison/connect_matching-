...
**MATCHED ORGANIZATION: **`r df$organization[1]` 
\bigskip
...
skill <- df |> 
  pivot_longer(23:47, names_to = "Skill", values_to = "Value") |> 
  filter(Value > 1) |> 
  mutate(
...
knitr::include_graphics("C:/Users/tenis/Desktop/Data_Projects/connect_matching/rmarkdown/images/hobby_logo.png")
