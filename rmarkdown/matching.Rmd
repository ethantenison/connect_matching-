...
```{r project_deliverables, fig.width=8}
library(wordcloud)
...
There were `r length(org$organization)` projects, but some of them involve multiple buckets. Of note, this semester there were zero web design projects.
...
```{r student_skills, fig.width=8, fig.height=6}
...
```{r desired_pop, layout="l-body-outset"}
stu_table2 <- stu |> 
