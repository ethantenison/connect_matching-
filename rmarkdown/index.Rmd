...
library(shiny)      #Data Dashboard package 
library(bslib)
...
Project CONNECT continues to offer a diverse set of projects to students. The word cloud below shows the most common words located in the project deliverable section. 
...
knitr::include_graphics("C:/Users/tenis/Desktop/Data_Projects/connect_matching/reports/RGB_formal_RGK.png")
```